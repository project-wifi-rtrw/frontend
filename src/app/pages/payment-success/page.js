    ...
    <>
      <div className="bg-white h-screen w-screen flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mt-10 gap-4">
          <a href="/pages/dashboard" className="btn text-xl bg-[#00C985] text-white font-bold border-none shadow-2xl ">Lanjut Berlangganan</a>
          {/* <a href="./pages/dashboard"><button className="btn text-xl bg-transparent border-4 border-[#00C985] text-[#00C985] font-bold shadow-2xl w-[30vw]">Kembali</button></a> */}
        </div>
      </div>
    </>
  );
